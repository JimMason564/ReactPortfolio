...
export default function Portfolio() {
  ...
  const [projects] = useState([
    ...
    {
      name: 'Notetaker',
      description:'This is a simple note taker app that will allow the user to write, save, and delete notes',
    ...
    },
    {
      ...
      description:'A text editor that allows the user to enter text while online and then download the app and retain functionality without a web connection. This app utilizes Webpack, Javascript, and IDB.',
